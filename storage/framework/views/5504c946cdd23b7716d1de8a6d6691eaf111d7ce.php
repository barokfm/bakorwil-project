...
<head>
    ...
    <title>Bakorwil | Dashboard <?php if(auth()->guard()->check()): ?>
...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
        ...
        <symbol id="search" viewBox="0 0 16 16">
            <path.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0
                1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
        </symbol>
    </svg>

    <header class="navbar sticky-top bg-primary-subtle flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Bakorwil</a>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <div class="container d-flex flex-row position-relative align-items-center mb-3">
                                <img src="storage/<?php echo e(auth()->user()->avatar); ?>" alt="avatar" width="60">
                            ...
                            <hr class="mb-3 border-top border-dark">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 <?php echo e(Request::is('dashboard') ? 'activated' : ''); ?>"
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 <?php echo e(Request::is('data') ? 'activated' : ''); ?>"
                                    href="/data">
                                    <svg class="bi">
                                        <use xlink:href="#data" />
                                    </svg>
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 <?php echo e(Request::is('profil') ? 'activated' : ''); ?>"
                                href="/profil">
                                    <svg class="bi">
            ...
            <?php echo $__env->yieldContent('main-page'); ?>
...
<?php endif; ?>
    ...
    <script src="/printPage/jquery.printPage.js" type="text/javascript"></script>

    <?php echo $__env->yieldPushContent('script'); ?>
</body>

</html>
<?php /**PATH C:\Users\AlifCom\Music\BAKORWIL\peminjaman-bakorwil\resources\views/user/layouts/utama.blade.php ENDPATH**/ ?>